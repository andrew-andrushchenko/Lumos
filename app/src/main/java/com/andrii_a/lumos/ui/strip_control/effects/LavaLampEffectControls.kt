...
fun LavaLampEffectControls(
    ...
    Box(
        ...
        Column(
            ...
            Icon(
                painter = painterResource(id = R.drawable.ic_lava_lamp),
                contentDescription = stringResource(id = R.string.effect_lava_lamp),
...
@Preview
@Composable
fun LavaLampEffectControlsPreview() {
    LumosTheme {
